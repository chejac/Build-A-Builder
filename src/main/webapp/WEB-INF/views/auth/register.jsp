...
<body>
	...
	<section id="content">
		<div class="container d-flex justify-content-center">
			<form:form method="POST" modelAttribute="userForm" class="form-content shadow">
				<h4 class="form-heading py-2">Create your account</h4>
				<div class="form-params align-items-center">
					...
					<div class="form-param text-center">
						<button class="btn btn-primary form-button" type="submit">Register</button>
					</div>
				</div>
			</form:form>
		</div>
